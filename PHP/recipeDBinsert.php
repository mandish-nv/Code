...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  //default value hala
  $sql = "insert into recipe values ('" . $recipeName . "','" . $chefName . "','" . $category . "','" . $difficultyLevel . "'," . $servingPortion . "," . $timeRequiredHour . "," . $timeRequiredSecond . ",'" . $ingredientsRequired . "','" . $procedureSteps . "','" . $nutritionalFacts . "','" . $tipsTricks . "','" . $file_name . "',0);";
  echo $sql;
